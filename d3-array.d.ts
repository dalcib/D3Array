...
/**
 * Returns the greatest element of the specified iterable.
 */
export function greatest<T>(array: Iterable<T>): T | undefined;

/**
 * Returns the greatest element of the specified iterable according to the specified comparator.
 */
...
/**
 * Returns the greatest element of the specified iterable according to the specified accessor.
 */
...
/**
 * Returns the index of the greatest element of the specified iterable according to the specified comparator.
 */
export function greatestIndex<T>(array: Iterable<T>): number | undefined;
...
/**
 * Returns the index of the greatest element of the specified iterable according to the specified accessor.
 */
...
export function rollups<TObject, TKey, TReduce>(
  a: Iterable<TObject>,
  reduce: Reducer<TObject, TReduce>,
  ...keys: Accessor<TObject, TKey>[]
): [TKey, TReduce][];
...
export function difference<T>(...arrays: Array<T[]>): T[];
export function intersection<T>(...arrays: Array<T[]>): T[];
export function subset<T>(a: Array<T>, b: Array<T>): boolean;
export function superset<T>(a: Array<T>, b: Array<T>): boolean;
export function disjoint<T>(a: Array<T>, b: Array<T>): boolean;
